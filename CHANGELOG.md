...
- Automate releases with release-please + git-cliff- Verify APK signature and add manual signing smoke test

### Documentation
- Rewrite README for Thor users and add docs/TECHNICAL.md

### Features
- Detect pre-existing JamesDSP installs and guide the user
